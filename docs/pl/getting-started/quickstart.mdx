...
Do codziennej pracy lokalnej utwórz profil lokalny i zastąp linię
...
<LinkCard
  ...
  description="Użyj lokalnego profilu lokalnego po pierwszym uruchomieniu w środowisku TEST."
/>
<LinkCard
